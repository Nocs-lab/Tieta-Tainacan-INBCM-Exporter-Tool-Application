    ...
    public function options_form() {
        ...
        ?>
            <div>
                ...
                <p><?php _e('This exporter will generate a XLSX file with the metadata of the items in the collection.', 'tieta-tainacan'); ?></p>
                <p><?php _e('Before exporting make sure to map your collection visiting metadata > mapping', 'tieta-tainacan'); ?></p>
            </div>
